...
export const VehicleSearchSection = ({ onVerify, isFetching, fetchError }) => {
  ...
  const hasSearchValue = mvFileNo.trim() || plateNo.trim() || engineNo.trim() || chassisNo.trim();
  ...
  return (
    <Card className="p-4 mb-6">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-xs text-gray-400">Search LTO database</span>
      </div>
      ...
      <div className="flex gap-2 mb-3">
        <input
          ...
          className="flex-1 bg-gray-50 border border-gray-200 rounded-lg px-2 py-1.5 text-xs font-mono text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 uppercase"
        />
