  ...
  return (
    <Card className="p-5 mb-5">
      <div className="flex items-center gap-2 mb-4 pb-2 border-b border-gray-200">
        ...
        <h3 className="text-base font-bold text-gray-900">Vehicle Information</h3>
        <span className="text-xs text-green-600 ml-auto">✓ Verified from LTO Database</span>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {fields.map(field => (
          <div key={field.key} className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-sm font-medium text-gray-900">{vehicleData[field.key] || "—"}</p>
          </div>
        ))}
      </div>
    </Card>
