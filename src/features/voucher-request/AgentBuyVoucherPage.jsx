...
import { useVoucherInventory } from "../clearance-request/hooks/useVoucherInventory";
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-5">
      <div className="bg-white rounded-xl shadow-lg p-4 flex items-center gap-3 border border-gray-100">
        ...
        <div>
          <h1 className="text-xl font-bold text-gray-900">Transaction Credits</h1>
          <p className="text-sm text-gray-500">Purchase transaction credits in bulk and manage their inventory status.</p>
        </div>
      </div>
